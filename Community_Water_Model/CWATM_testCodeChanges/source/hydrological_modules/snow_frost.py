...
# 
# Changes:
# YW 2018/06/20 to later summerSeasonStart & longer summer season
# -------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
    ...
    def initial(self):
        ...
        * loads the parameter for frost
        ...
        self.var.summerSeasonStart = 182
        #self.var.IceDayDegrees = 1.915
        self.var.IceDayDegrees = 180./(273- self.var.summerSeasonStart)
        # days of summer (1st July-30th Sept.) to degree: 180/(273-182)

...
Parameters
    ...
    bound_storage_up(node,commodity,level,year_all,time)   upper bound on stocks
    bound_storage_lo(node,commodity,level,year_all,time)   lower bound on stocks
    storage_loss(node,commodity,level,year_all,time)       losses from storage
;
